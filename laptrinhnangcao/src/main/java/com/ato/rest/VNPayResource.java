...
public class VNPayResource {
    ...
    private ResponseEntity<Object> thanhToan() throws ServletException, IOException {
        ...
        int amount = Integer.parseInt(String.valueOf(10000000)) * 100;
