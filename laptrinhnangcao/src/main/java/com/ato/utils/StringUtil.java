...
public class StringUtil {
    ...
    public static int DemKhoangTrang(String input){
        input = input.trim();
        int count = 0;
    ...
    public static boolean KiemTraKyTuDacBiet(String input){
    ...
    public static boolean KiemTraKyTuDacBietAreaName(String input){
        String regex = "^.*[!@#$%^&*()+\\\\=\\\\[\\\\]{}_;':\\\"\\\\\\\\|,<>\\\\/?].*$";
        if(input.matches( regex )){
            return true;
        }
    ...
    public static String extractFileNameNotExt(String fileName) {
        fileName = StringUtil.getSafeFileName( fileName );
    ...
    public static boolean isExtendAllowSave(String fileName, String fileExtAllowSave) {
        ...
        if (fileName != null && !("").equals( fileName ) && fileExtAllowSave != null) {
            String ext = StringUtil.extractFileExt( fileName ).trim();
